...
// subscribing to and unsubscribing from events. This is the core interface
...
//
// Pattern: This follows the same lifecycle pattern as ConditionBehavior in
// rulebooks/dnd5e/events but is defined at the core level to be used across
// all game systems. The mechanics/effects.Core type provides a concrete
// implementation with subscription tracking.
//
// Examples:
