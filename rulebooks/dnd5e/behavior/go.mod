module github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/behavior
...
require (
	...
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/encounter v0.84.1-0.20260916072353-4b2e49d2ac0c
