...
// All concrete types implement the same three methods:
// - GetSource() returns the source of the choice (player, class, race, etc.)
// - GetChoiceID() returns the unique identifier for this specific choice
// - GetCategory() returns the category/type of choice
...
func (c ToolProficiencyChoice) GetCategory() shared.ChoiceCategory {
...
func (c InstrumentProficiencyChoice) GetCategory() shared.ChoiceCategory {
	return shared.ChoiceToolProficiency
} // For now, until we add a separate category
