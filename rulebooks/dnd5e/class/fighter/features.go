		...
		2: {
			{
				...
				Description: "Starting at 2nd level, you can push yourself beyond your normal limits for a moment. " +
					"On your turn, you can take one additional action. Once you use this feature, you must finish " +
		...
		3: {
			{
				...
				Level: 3,
				Description: "At 3rd level, you choose an archetype that you strive to emulate in your " +
		...
		4: {
			{
				...
				Description: "When you reach 4th level, and again at 6th, 8th, 12th, 14th, 16th, and 19th level, " +
					"you can increase one ability score of your choice by 2, or you can increase two ability scores " +
		...
		5: {
			{
				...
				Name:  "Extra Attack",
				Level: 5,
				Description: "Beginning at 5th level, you can attack twice, instead of once, whenever you take " +
					"the Attack action on your turn. The number of attacks increases to three when you reach 11th " +
		...
		6: {
			{
				...
				Name:  "Ability Score Improvement",
				Level: 6,
				Description: "You can increase one ability score of your choice by 2, or you can increase " +
		...
		9: {
			{
				...
				Name:  "Indomitable",
				Level: 9,
				Description: "Beginning at 9th level, you can reroll a saving throw that you fail. If you do so, " +
					"you must use the new roll, and you can't use this feature again until you finish a long rest. " +
