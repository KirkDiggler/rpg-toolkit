...
// Source: github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/combat (interfaces: Combatant)
//
// Generated by this command:
//
//	mockgen -destination=combat/mock/mock_combatant.go -package=mock_combat github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/combat Combatant
//
...
// HasShieldEquipped mocks base method.
func (m *MockCombatant) HasShieldEquipped() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "HasShieldEquipped")
	ret0, _ := ret[0].(bool)
	return ret0
}

// HasShieldEquipped indicates an expected call of HasShieldEquipped.
func (mr *MockCombatantMockRecorder) HasShieldEquipped() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasShieldEquipped", reflect.TypeOf((*MockCombatant)(nil).HasShieldEquipped))
}
