...
func LoadJSON(data json.RawMessage) (dnd5eEvents.ConditionBehavior, error) {
	...
	case UnarmoredDefenseBarbarianID, UnarmoredDefenseMonkID, "unarmored_defense":
		// Support both new split IDs and legacy "unarmored_defense" for backward compatibility
