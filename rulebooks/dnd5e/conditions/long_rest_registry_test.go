...
var longRestCases = map[string]longRestCase{
	...
	refs.Conditions.DivineFavor().String(): {
		data: json.RawMessage(`{
			"ref":{"module":"dnd5e","type":"conditions","id":"divine_favor"},
			"member_id":"member-1","source_id":"member-1",
			"source_ref":{"module":"dnd5e","type":"spells","id":"divine-favor"}
		}`),
		ownerID:          "member-1",
	...
	refs.Conditions.Guided().String(): {
		data: json.RawMessage(`{
			...
			"member_id":"member-1","source_id":"cleric-1",
			"source_ref":{"module":"dnd5e","type":"spells","id":"guidance"}
		}`),
		ownerID:          "member-1",
	...
	refs.Conditions.Resistance().String(): {
		data: json.RawMessage(`{
			"ref":{"module":"dnd5e","type":"conditions","id":"resistance"},
			"member_id":"member-1","source_id":"cleric-1",
			"source_ref":{"module":"dnd5e","type":"spells","id":"resistance"}
		}`),
		ownerID:          "member-1",
