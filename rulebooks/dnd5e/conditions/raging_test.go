...
// testRageSourceRef is a test helper for creating raging conditions with the standard source
var testRageSourceRef = &core.Ref{Module: "dnd5e", Type: "features", ID: "rage"}
...
func (s *RagingConditionTestSuite) executeDamageChain(
	...
	chain := events.NewStagedChain[*dnd5eEvents.DamageChainEvent](dnd5eEvents.ModifierStages)
...
func (s *RagingConditionTestSuite) TestRagingConditionAddsDamageBonus() {
	...
	s.Equal(dnd5eEvents.DamageSourceRage, finalEvent.Components[2].Source)
