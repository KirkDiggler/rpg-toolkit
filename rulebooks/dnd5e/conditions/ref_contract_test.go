...
func refContractTable() map[string]dnd5eEvents.ConditionBehavior {
	...
	return map[string]dnd5eEvents.ConditionBehavior{
		...
		"brutal_critical":   NewBrutalCriticalCondition(BrutalCriticalInput{CharacterID: "m1", Level: 9, Roller: roller}),
		"unarmored_defense": NewUnarmoredDefenseCondition(UnarmoredDefenseInput{CharacterID: "m1", Type: UnarmoredDefenseBarbarian}),
		...
		"improved_critical": NewImprovedCriticalCondition(ImprovedCriticalInput{CharacterID: "m1"}),
		"reckless_attack":   NewRecklessAttackCondition("m1"),
		"martial_arts":      NewMartialArtsCondition(MartialArtsInput{CharacterID: "m1", MonkLevel: 5, Roller: roller}),
		"unarmored_move":    NewUnarmoredMovementCondition(UnarmoredMovementInput{CharacterID: "m1", MonkLevel: 5}),
		"sneak_attack":      NewSneakAttackCondition(SneakAttackInput{CharacterID: "m1", Level: 5, Roller: roller}),
