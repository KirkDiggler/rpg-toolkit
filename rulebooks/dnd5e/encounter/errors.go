...
var (
	...
	// standing reason, applied to the world's own answer roll: a silent
	...
	// ErrBadAnswer is returned when a member's authored answer table is
	// one this composition could not roll: an outcome key it does not know,
	// or an entry weighing less than 1 (answer.go, rpg-project#458).
	//
