...
func benchSightRefreshOn(b *testing.B, field FieldInput, rooms, dim, members int) {
	...
	enc, err := NewEncounter(&SetupInput{
		Sight: benchSight{1 << 20}, Equipment: noHandsAreObserved{}, Standing: benchStanding{}, Initiative: benchRoller{}, TurnDriver: passDriver{}, Striker: passStriker{}, Mover: quietMover{}, Announcer: quietAnnouncer{},
		Field:   field,
		Members: mi,
