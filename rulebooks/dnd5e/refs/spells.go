...
// spellByID maps spell ID strings to singleton refs for O(1) lookup, the same
// shape [weaponsNS.ByID] keeps and for the same reason: content elsewhere
// names a spell by its id, and turning that id into an identity must go
// through the catalog rather than composing a ref out of the string. A
// composed ref cannot be wrong, which is exactly the problem — it would point
// at a spell that does not exist and nothing would say so.
//
// Generated from the singletons above; every ref in this file has a row.
var spellByID = map[string]*core.Ref{
	"fire-bolt":                     spellFireBolt,
	"ray-of-frost":                  spellRayOfFrost,
	"shocking-grasp":                spellShockingGrasp,
	"acid-splash":                   spellAcidSplash,
	...
	"mold-earth":                    spellMoldEarth,
	"shape-water":                   spellShapeWater,
	"booming-blade":                 spellBoomingBlade,
	"control-flames":                spellControlFlames,
	"green-flame-blade":             spellGreenFlameBlade,
	"gust":                          spellGust,
	"sword-burst":                   spellSwordBurst,
	"mage-hand":                     spellMageHand,
	"minor-illusion":                spellMinorIllusion,
	"prestidigitation":              spellPrestidigitation,
	"light":                         spellLight,
	"guidance":                      spellGuidance,
	"resistance":                    spellResistance,
	"thaumaturgy":                   spellThaumaturgy,
	"spare-the-dying":               spellSpareTheDying,
	"blade-ward":                    spellBladeWard,
	"dancing-lights":                spellDancingLights,
	"friends":                       spellFriends,
	"mending":                       spellMending,
	"message":                       spellMessage,
	"true-strike":                   spellTrueStrike,
	"vicious-mockery":               spellViciousMockery,
	...
	"inflict-wounds":                spellInflictWounds,
	"hail-of-thorns":                spellHailOfThorns,
	"ensnaring-strike":              spellEnsnaringStrike,
	"hellish-rebuke":                spellHellishRebuke,
	"arms-of-hadar":                 spellArmsOfHadar,
	"hex":                           spellHex,
	"searing-smite":                 spellSearingSmite,
	"thunderous-smite":              spellThunderousSmite,
	"wrathful-smite":                spellWrathfulSmite,
	"shield":                        spellShield,
	"sleep":                         spellSleep,
	"charm-person":                  spellCharmPerson,
	"detect-magic":                  spellDetectMagic,
	"identify":                      spellIdentify,
	"cure-wounds":                   spellCureWounds,
	"healing-word":                  spellHealingWord,
	"bless":                         spellBless,
	"bane":                          spellBane,
	...
	"divine-favor":                  spellDivineFavor,
	"faerie-fire":                   spellFaerieFire,
	"false-life":                    spellFalseLife,
	"fog-cloud":                     spellFogCloud,
	"ray-of-sickness":               spellRayOfSickness,
	"speak-with-animals":            spellSpeakWithAnimals,
	"comprehend-languages":          spellComprehendLanguages,
	"feather-fall":                  spellFeatherFall,
	"heroism":                       spellHeroism,
	"hideous-laughter":              spellHideousLaughter,
	"illusory-script":               spellIllusoryScript,
	"longstrider":                   spellLongstrider,
	"silent-image":                  spellSilentImage,
	"unseen-servant":                spellUnseenServant,
	"absorb-elements":               spellAbsorbElements,
	"beast-bond":                    spellBeastBond,
	"entangle":                      spellEntangle,
	"goodberry":                     spellGoodberry,
	"jump":                          spellJump,
	"purify-food-and-drink":         spellPurifyFood,
	"catapult":                      spellCatapult,
	"cause-fear":                    spellCauseFear,
	"color-spray":                   spellColorSpray,
	"distort-value":                 spellDistortValue,
	"earth-tremor":                  spellEarthTremor,
	"expeditious-retreat":           spellExpeditiousRetreat,
	"protection-from-evil-and-good": spellProtectionEvil,
	"scorching-ray":                 spellScorchingRay,
	"shatter":                       spellShatter,
	"aganazzars-scorcher":           spellAganazzarsScorcher,
	"cloud-of-daggers":              spellCloudOfDaggers,
	"melfs-acid-arrow":              spellMelfsAcidArrow,
	"moonbeam":                      spellMoonbeam,
	"spiritual-weapon":              spellSpiritualWeapon,
	"flaming-sphere":                spellFlamingSphere,
	"gust-of-wind":                  spellGustOfWind,
	"ray-of-enfeeblement":           spellRayOfEnfeeblement,
	"augury":                        spellAugury,
	"barkskin":                      spellBarkskin,
	"blindness-deafness":            spellBlindnessDeafness,
	"lesser-restoration":            spellLesserRestoration,
	"magic-weapon":                  spellMagicWeapon,
	"mirror-image":                  spellMirrorImage,
	"pass-without-trace":            spellPassWithoutTrace,
	"spike-growth":                  spellSpikeGrowth,
	"suggestion":                    spellSuggestion,
	"fireball":                      spellFireball,
	"lightning-bolt":                spellLightningBolt,
	"call-lightning":                spellCallLightning,
	"vampiric-touch":                spellVampiricTouch,
	"sleet-storm":                   spellSleetStorm,
	"spirit-guardians":              spellSpiritGuardians,
	"animate-dead":                  spellAnimateDead,
	"beacon-of-hope":                spellBeaconOfHope,
	"blink":                         spellBlink,
	"crusaders-mantle":              spellCrusadersMantle,
	"daylight":                      spellDaylight,
	"dispel-magic":                  spellDispelMagic,
	"nondetection":                  spellNondetection,
	"plant-growth":                  spellPlantGrowth,
	"revivify":                      spellRevivify,
	"speak-with-dead":               spellSpeakWithDead,
	"wind-wall":                     spellWindWall,
	"arcane-eye":                    spellArcaneEye,
	"blight":                        spellBlight,
	"confusion":                     spellConfusion,
	"control-water":                 spellControlWater,
	"death-ward":                    spellDeathWard,
	"dimension-door":                spellDimensionDoor,
	"dominate-beast":                spellDominateBeast,
	"freedom-of-movement":           spellFreedomOfMovement,
	"grasping-vine":                 spellGraspingVine,
	"guardian-of-faith":             spellGuardianOfFaith,
	"ice-storm":                     spellIceStorm,
	"polymorph":                     spellPolymorph,
	"stoneskin":                     spellStoneskin,
	"wall-of-fire":                  spellWallOfFire,
	"antilife-shell":                spellAntiLifeShell,
	"cloudkill":                     spellCloudkill,
	"destructive-wave":              spellDestructiveWave,
	"dominate-person":               spellDominatePerson,
	"flame-strike":                  spellFlameStrike,
	"hold-monster":                  spellHoldMonster,
	"insect-plague":                 spellInsectPlague,
	"legend-lore":                   spellLegendLore,
	"mass-cure-wounds":              spellMassCureWounds,
	"modify-memory":                 spellModifyMemory,
	"raise-dead":                    spellRaiseDead,
	"scrying":                       spellScrying,
	"tree-stride":                   spellTreeStride,
}

// ByID returns the singleton ref for the given spell ID, or nil when this
// build has no such spell.
func (n spellsNS) ByID(id string) *core.Ref {
	return spellByID[id]
}
