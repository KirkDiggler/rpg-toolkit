...
require (
	...
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/encounter v0.99.1-0.20260922015432-e4703775d5d8
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/resolution v0.56.0
