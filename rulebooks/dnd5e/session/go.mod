...
require (
	...
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/encounter v0.71.1-0.20260911014124-333e4a275653
	github.com/KirkDiggler/rpg-toolkit/rulebooks/dnd5e/resolution v0.40.0
