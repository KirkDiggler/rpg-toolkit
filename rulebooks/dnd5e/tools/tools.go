...
// ToolID represents unique identifier for tools (alias of shared.EquipmentID)
type ToolID = shared.EquipmentID
...
func (t *Tool) EquipmentType() shared.EquipmentType {
...
func (t *Tool) EquipmentWeight() float32 {
	return t.Weight
}

// EquipmentValue returns the value in copper pieces
func (t *Tool) EquipmentValue() int {
	// TODO: Parse cost string (e.g., "25 gp") and convert to copper
	// For now, return a placeholder
	return 0
}

// EquipmentDescription returns a description of the tool
func (t *Tool) EquipmentDescription() string {
	if t.Description != "" {
