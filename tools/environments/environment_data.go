...
// Typed String Types
// ============================================================================
// These types provide IDE discoverability. The environments package defines
// the types; rulebooks define constants using these types.

// EnvironmentType is a typed string for environment categorization.
// Rulebooks define constants using this type (e.g., "dungeon", "cave", "town").
type EnvironmentType string

// PropertyKey is a typed string for entity property keys.
// Rulebooks define constants using this type (e.g., "open", "locked", "dc").
// Using typed keys provides IDE autocomplete for property discovery.
type PropertyKey string

// GridShapeValue is a typed string for grid shape serialization.
// Maps to spatial.GridShape during load/save operations.
...
// HexOrientationValue is a typed string for hex grid orientation serialization.
// Maps to spatial.HexOrientation during load/save operations.
...
// ============================================================================
// These structures enable full round-trip fidelity for BasicEnvironment.
// ToData() followed by LoadFromData() produces a functionally equivalent environment.
