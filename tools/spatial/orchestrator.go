...
// Multi-room orchestration event constants
const (
...
// RoomAddedData contains data for room addition events
type RoomAddedData struct {
	OrchestratorID string `json:"orchestrator_id"`
	Room           Room   `json:"room"`
}

// RoomRemovedData contains data for room removal events
type RoomRemovedData struct {
	OrchestratorID string `json:"orchestrator_id"`
	RoomID         string `json:"room_id"`
}

// ConnectionAddedData contains data for connection addition events
type ConnectionAddedData struct {
	OrchestratorID string     `json:"orchestrator_id"`
	Connection     Connection `json:"connection"`
}

// ConnectionRemovedData contains data for connection removal events
type ConnectionRemovedData struct {
	OrchestratorID string `json:"orchestrator_id"`
	ConnectionID   string `json:"connection_id"`
}

// EntityTransitionBeganData contains data for transition start events
type EntityTransitionBeganData struct {
	OrchestratorID string     `json:"orchestrator_id"`
	Transition     Transition `json:"transition"`
}

// EntityTransitionEndedData contains data for transition completion events
type EntityTransitionEndedData struct {
	OrchestratorID string       `json:"orchestrator_id"`
...
// LayoutChangedData contains data for layout modification events
type LayoutChangedData struct {
	OrchestratorID string        `json:"orchestrator_id"`
	OldLayout      LayoutType    `json:"old_layout"`
	NewLayout      LayoutType    `json:"new_layout"`
