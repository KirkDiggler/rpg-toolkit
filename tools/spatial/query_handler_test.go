...
func (s *QueryHandlerTestSuite) SetupTest() {
	...
	s.room.PlaceEntity(s.entity1, spatial.Position{X: 3, Y: 3})
	s.room.PlaceEntity(s.entity2, spatial.Position{X: 6, Y: 6})
	s.room.PlaceEntity(s.entity3, spatial.Position{X: 8, Y: 8})
}
