...
func (s *RoomTestSuite) SetupTest() {
	...
	s.eventBus.SubscribeFunc(spatial.EventEntityPlaced, 0, func(ctx context.Context, event events.Event) error {
		s.capturedEvents = append(s.capturedEvents, event)
		return nil
	})
	s.eventBus.SubscribeFunc(spatial.EventEntityMoved, 0, func(ctx context.Context, event events.Event) error {
		s.capturedEvents = append(s.capturedEvents, event)
		return nil
	})
	s.eventBus.SubscribeFunc(spatial.EventEntityRemoved, 0, func(ctx context.Context, event events.Event) error {
		s.capturedEvents = append(s.capturedEvents, event)
		return nil
	})
	s.eventBus.SubscribeFunc(spatial.EventRoomCreated, 0, func(ctx context.Context, event events.Event) error {
		s.capturedEvents = append(s.capturedEvents, event)
		return nil
	})
...
func (s *RoomTestSuite) TestEventBusIntegration() {
	...
	newBus.SubscribeFunc(spatial.EventEntityPlaced, 0, func(ctx context.Context, event events.Event) error {
