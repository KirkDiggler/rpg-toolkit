...
//
// The module is rulebook-free by construction: its only external dependency is
// testify. A rulebook plugs in through [Resolver], the one seam this package
// consults for anything a die or a class feature would decide. Design record:
